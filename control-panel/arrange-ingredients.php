...
$INGREDIENT = $INGREDIENTS->getIngredientsByProductId($id);
?>
<!DOCTYPE html>
<html> 
    <head>
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Ingredients</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="view-ingredients.php?id=<?php echo $id; ?>">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/ingredients.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($INGREDIENT) > 0) {
                                                        foreach ($INGREDIENT as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/product-type/product/ingredients/<?php echo $img["image_name"]; ?> " alt=""/>
