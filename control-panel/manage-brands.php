                                            ...
                                            foreach ($BRAND as $key => $brand) {
                                                ...
                                                <div class="col-md-3"  id="div<?php echo $brand['id']; ?>">
                                                    <div class="photo-img-container">
                                                        <img src="../upload/brand/<?php echo $brand['image_name']; ?>" class="img-responsive" style="width: 70%;">
                                                    </div>
                                                    <div class="img-caption">
                                                        ...
                                                        <div class="d">
                                                            ...
                                                            <a href="edit-brand.php?id=<?php echo $brand['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a>
                                                            <a href="arrange-brands.php?id=<?php echo $brand['id']; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                            <?php
