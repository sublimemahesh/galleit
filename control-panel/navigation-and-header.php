    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <!-- Notifications -->
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button"> <i class="material-icons">notifications</i> <span class="label-count">7</span> </a>
                ...
                <!-- Tasks -->
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button"> <i class="material-icons">flag</i> <span class="label-count">9</span> </a>
                    <ul class="dropdown-menu">
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown"> <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">settings</i>
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <a href="profile.php?id=<?php echo $_SESSION['id']; ?>"> <i class="material-icons">person</i>Profile</a>
                        </li>
            ...
            <ul class="list">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            <a href="manage-unpaid-orders.php">
                                <i class="material-icons">list</i>
                                <span>Manage Unpaid Orders</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="create-before-after-result.php">
                                <i class="material-icons">add</i>
                                <span>Add New</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="arrange-before-after-results.php">
                                <i class="material-icons">compare_arrows</i>
                                <span>Arrange</span>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="report-of-completed-orders.php">
                                <i class="material-icons">list</i>
                                <span>Completed Orders</span>
                            </a>
                        </li>
                        <li>
                            <a href="report-of-delivered-orders.php">
                                <i class="material-icons">list</i>
                                <span>Delivered Orders</span>
                            </a>
                        </li>
                        <li>
                            <a href="report-of-pending-orders.php">
                                <i class="material-icons">list</i>
                                <span>Pending Orders</span>
                            </a>
                        </li>
                        <li>
                            <a href="report-of-unpaid-orders.php">
                                <i class="material-icons">list</i>
