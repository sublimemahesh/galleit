...
$COUNT_UNPAID_ORDERS = count(Order::getUnpaidOrders());
$COUNT_ORDERS = count(Order::all());
$COUNT_SLIDERS = count(Slider::all());
?>
<!DOCTYPE html>
<html>
                    ...
                    <a href="manage-unpaid-orders.php">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box bg-orange hover-expand-effect">
                                ...
                                <div class="content">
                                    <div class="text">Unpaid Orders</div>
                                    <div class="number count-to" data-from="0" data-to="<?php echo $COUNT_UNPAID_ORDERS; ?>" data-speed="1500" data-fresh-interval="1"></div>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card">
                            <div class="header bg-blue-grey">
                                <h2>SLIDER</h2>
                                <ul class="header-dropdown m-r--5">
                                    <div class="number count-to" data-from="0" data-to=" <?php echo $COUNT_SLIDERS; ?>" data-speed="1500" data-fresh-interval="1"></div>
                                </ul>
                            </div>
                            <div class="body">
                                <div class="list-group">
